# Generated by Django 4.0.3 on 2025-01-28 15:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('dashboard', '0002_preguntas_categoria'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ImageField(blank=True, default='images/users/user-4.jpg', null=True, upload_to='emedia/')),
                ('groups', models.ManyToManyField(blank=True, related_name='usuario_personalizado_set', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='usuario_personalizado_set', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
